...
var rest = new discord_js_1.REST().setToken(config_json_1.token);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, rest.put(discord_js_1.Routes.applicationGuildCommands(config_json_1.clientId, config_json_1.guildId), { body: commands })];
            case 1:
                data = _a.sent();
