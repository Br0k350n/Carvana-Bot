...
local Vehicles = {
    ...
    { model = 'blista',        name = 'Blista',                        brand = 'Dinka',           price = 10000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso',        name = 'Brioso R/A',                    brand = 'Grotti',          price = 12500,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'issi4',         name = 'Issi Arena',                    brand = 'Weeny',           price = 22000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi5',         name = 'Issi Future Shock',             brand = 'Weeny',           price = 22000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi6',         name = 'Issi Nightmare',                brand = 'Weeny',           price = 22000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'panto',         name = 'Panto',                         brand = 'Benefactor',      price = 4200,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'issi7',         name = 'Issi Sport',                    brand = 'Weeny',           price = 47000,  category = 'compacts',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'brioso3',       name = 'Brioso 300 Widebody',           brand = 'Grotti',          price = 32000,  category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'boor',          name = 'Boor',                          brand = 'Karin',           price = 23000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    --- Sedans (1)
    { model = 'asea',          name = 'Asea',                          brand = 'Declasse',        price = 3500,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'iwagen',        name = 'Obey',                          brand = 'I-Wagen',         price = 125000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'astron',        name = 'Astron',                        brand = 'Pfister',         price = 123000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'baller7',       name = 'Baller ST',                     brand = 'Gallivanter',     price = 121000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'rhinehart',     name = 'Rhinehart',                     brand = 'Übermacht',       price = 84000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'granger2',      name = 'Granger 3600LX',                brand = 'Declasse',        price = 145000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'patriot3',      name = 'Patriot Military',              brand = 'Mil-Spec',        price = 400000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    --- Coupes (3)
    ...
    { model = 'casco',         name = 'Casco',                         brand = 'Lampadati',       price = 85000,  category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    ...
    { model = 'feltzer2',      name = 'Feltzer',                       brand = 'Benefactor',      price = 65000,   category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'italigto',      name = 'Itali GTO',                     brand = 'Progen',          price = 185000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'locust',        name = 'Locust',                        brand = 'Ocelot',          price = 133000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'neo',           name = 'Neo',                           brand = 'Vysser',          price = 150000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'neon',          name = 'Neon',                          brand = 'Pfister',         price = 99000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'ruston',        name = 'Ruston',                        brand = 'Hijak',           price = 94000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'seven70',       name = 'Seven-70',                      brand = 'Dewbauchee',      price = 99000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'specter',       name = 'Specter',                       brand = 'Dewbauchee',      price = 101000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'jester4',       name = 'Jester RR',                     brand = 'Dinka',           price = 169000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'remus',         name = 'Remus',                         brand = 'Annis',           price = 48000,   category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'comet6',        name = 'Comet S2',                      brand = 'Pfister',         price = 175000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'growler',       name = 'Growler',                       brand = 'Pfister',         price = 175000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 't20',           name = 'T20',                           brand = 'Progen',          price = 330000, category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'taipan',        name = 'Taipan',                        brand = 'Cheval',          price = 350000, category = 'super',          type = 'automobile', shop = 'luxury' },
