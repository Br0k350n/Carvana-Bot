...
var _a = require('discord.js'), SlashCommandBuilder = _a.SlashCommandBuilder, Client = _a.Client, GatewayIntentBits = _a.GatewayIntentBits;
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    ...
                    dbConnection.query('SELECT 1', function (err, results) {
                        if (err) {
